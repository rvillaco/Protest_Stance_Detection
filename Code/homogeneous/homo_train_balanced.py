...
import pandas as pd
from config import *
from homo_import_balanced import gen_import_dict, import_data, balanced_loader
from sklearn.metrics import  accuracy_score, f1_score
from homo_model import HomoGAT
import random
...
if __name__ == '__main__':
    for country_name in ['Ecuador', 'Bolivia', 'Colombia', 'Chile']:
        ...
        train_loader, valid_loader, test_loader = balanced_loader(att_df, idx_df, mask_and_y_cache, true_y, 0, inference=False)
        ...
        torch.save(early_stopping.best_model, f'{MODEL_FOLDER}{country_name}_bal_gnn.pt')
