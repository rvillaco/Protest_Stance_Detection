...
import pandas as pd
from config import *
from hetero_import_balanced import gen_import_dict, import_data, balanced_loader
from torch_geometric.nn import to_hetero
from sklearn.metrics import  accuracy_score, f1_score
from het_model import GAT
import random
...
def train():
    ...
    for batch in tqdm(train_loader):
        ...
        loss = loss_fn(out, batch['users'].y[:batch_size])
        ...
        true_labs.append(batch['users'].y[:batch_size].cpu().numpy())
